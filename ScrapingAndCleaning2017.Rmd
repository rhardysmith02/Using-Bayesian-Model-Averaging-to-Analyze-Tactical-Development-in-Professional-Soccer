---
title: "Scraping and Cleaning 2017-2018"
...
```{r}
urls = c('https://fbref.com/en/comps/Big5/2017-2018/stats/players/2017-2018-Big-5-European-Leagues-Stats',
...
```{r}
write.csv(merged_df, '~/Desktop/Senior Seminar/merged_df2017.csv')
```
